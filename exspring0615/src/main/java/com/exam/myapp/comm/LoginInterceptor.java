...
public class LoginInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (vo==null) { //로그인 실패시, 로그인 화면으로 이동
			...
			//로그인 페이지로 이동
			response.sendRedirect(request.getContextPath() + "/student/login.do"); // 로그인 화면으로 이동
			return false; 
		}
		return true;
	}
...
//		if (!req.getRequestURI().equals( req.getContextPath() + "/student/login.do") ) { //요청 주소가 login.do면 그냥 통과하도록 설정 
//		if ( !(req.getRequestURI().equals( req.getContextPath() + "/student/login.do") || req.getRequestURI().equals( req.getContextPath() + "/student/add.do")) ) { //요청 주소가 login.do면 그냥 통과하도록 설정 
